...
import earth_image from '../assets/earthimage.png'
...
const ProductScreen = () => {
    ...
    return (
        <>
            <img src={earth_image} alt="" className="block md:hidden w-full mt-5 px-6" />
            <img src={corllel_gif} alt="" className="w-full mt-20 xs:w-full xs:mt-5" />

            <p className="text-center font-jost text-lg px-24 font-light leading-relaxed xs:px-4 xs:text-sm">
            ...
            >
                <button className="flex items-center font-jost font-light px-6 py-2 bg-white border border-black text-black rounded-full hover:bg-blue-900 hover:text-white transition-colors duration-300 xs:px-3 xs:py-1 xs:text-sm">
                    Visit
                    <HiArrowNarrowRight className="ml-2 xs:ml-1" />
                </button>
            </div>
            ...
            <div className='max-sm:hidden'>
                ...
                <div className=" xm:flex justify-center items-center mt-10 px-24 w-auto  mb-10">
                    <div
                    ...
                    >
                        ...
                        <div className="flex items-center w-2/5 transition-transform duration-700 ease-in-out group-hover:translate-x-full">
                            <div className="flex-col items-center pr-26 transition-transform duration-700 ease-in-out group-hover:translate-x-16">
                                ...
                                <p className="mt-4 text-center">Denationalize Your Vision with our 3D Assets</p>
                                <div
            ...
            <div className='hidden max-sm:block'>
                <div className="flex justify-center items-center mt-10 px-10 w-auto mb-10">
                    <div
                        className={`flex flex-col items-start border-2 border-blue-900 rounded-lg w-96 min-h-96 relative overflow-hidden group transition-shadow duration-300 ${isHovered ? 'shadow-lg shadow-gray-500' : ''}`}
                        onMouseEnter={() => setIsHovered(true)}
                        onMouseLeave={() => setIsHovered(false)}
                    >
                        <div className="flex">
                            <img src={man_vr} alt="" className="rounded-full w-24 h-24 object-cover m-4" />
                            <div className=''>
                                <img src={rivw_letter} alt="First" className="w-32 h-7 mt-7 ml-9 " />
                                <p className='mt-4 text-center font-poppins font-medium text-xs text-blue-900'>
                                    Immersive VR/Metaverse Experience
                                </p>
                            </div>
                        </div>
                        <div className=' font-jost font-light px-5 size text-xs'>
                            Embark on a journey like no other as we invite you to explore the infinite realms of the virtual universe. Our platform is your gateway to immersive experiences, where boundaries blur and imagination knows no limit. Dive into a kaleidoscope of virtual worlds each offering its own wonders and adventures. From bustling futuristic cities to serene natural landscapes, there’s something for every explorer to discover. Ready to embark on the ultimate virtual reality world tour? The future of exploration is here. Step into the virtual reality metaverse world tour and prepare to be amazed. Welcome to a world without limits.
                        </div>
                        <div className='mt-3 text-xs font-bold px-5 text-black'>
                            Welcome to the future adventure!!!
                        </div>
                        <div className='p-5 pl-64'>
                            <button className="flex items-center px-2 py-1 bg-white border text-sm border-black text-black rounded-full hover:bg-blue-900 hover:text-white transition-colors duration-300">
                                Visit
                ...
                <div className="flex justify-center items-center mt-10 px-10 w-auto mb-10">
                    ...
                    >
                        <div className="flex">
                            <img src={lostcontinent_img} alt="" className="rounded-full w-24 h-24 object-cover m-4" />
                            <div className=''>
                                <img src={letter_lostcontinent} alt="First" className="w-32 h-7 mt-7 ml-9 " />
                                <p className='mt-4 text-center pl-10 font-poppins font-medium text-xs text-blue-900'>
                                    Gaming Excellence
                                </p>
                            </div>
                        </div>
                ...
                <div className="flex justify-center items-center mt-10 px-10 w-auto mb-10">
                    ...
                    >
                        <div className="flex">
                            <img src={corlmart_img} alt="" className="rounded-full w-24 h-24 object-cover m-4" />
                            <div className=''>
                                <img src={corlmart_letter} alt="First" className="w-40 h-6 mt-7 ml-9 " />
                                <p className='mt-4 text-center  font-poppins font-medium text-xs text-blue-900'>
